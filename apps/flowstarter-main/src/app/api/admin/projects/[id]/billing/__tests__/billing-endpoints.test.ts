 ...
 *   1. POST /api/admin/projects/[id]/billing/deposit-invoice
 *   2. POST /api/admin/projects/[id]/billing/final-invoice
 *   3. POST /api/admin/projects/[id]/billing/activate-subscription
 *   4. POST /api/admin/projects/[id]/billing/cancel-subscription
 *   5. POST /api/admin/projects/[id]/billing/portal-link
 */
...
describe('POST /api/admin/projects/[id]/billing/deposit-invoice', () => {
...
describe('POST /api/admin/projects/[id]/billing/final-invoice', () => {
...
describe('POST /api/admin/projects/[id]/billing/activate-subscription', () => {
  beforeEach(() => {
...
describe('POST /api/admin/projects/[id]/billing/cancel-subscription', () => {
...
describe('POST /api/admin/projects/[id]/billing/portal-link', () => {
  ...
  it('defaults the return URL to the workspace dashboard', async () => {
    ...
    expect(stripeMock.billingPortal.sessions.create).toHaveBeenCalledWith({
      customer: 'cus_existing',
      return_url: 'https://flowstarter.dev/admin/dashboard/projects/proj_1',
    });
  });
  ...
  it.each([
    ...
    expect(arg?.return_url).toBe(
      'https://flowstarter.dev/admin/dashboard/projects/proj_1'
    );
  });
