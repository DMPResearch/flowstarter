...
> = {
  linkedin: {
    ...
    exchangeUrl: 'https://www.linkedin.com/oauth/v2/accessToken',
  ...
  instagram: {
    ...
    exchangeUrl: 'https://api.instagram.com/oauth/access_token',
    profileUrl: 'https://graph.instagram.com/v23.0/me',
...
export async function exchangePortraitCode(input: {
  ...
  const url = new URL(endpoints.profileUrl);
