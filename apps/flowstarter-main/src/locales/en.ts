...
const en = {
  ...
  // Agent activity timeline. Every string here is reached by a rule in
  // src/lib/flowstarter/activity/steps.ts from a token the pipeline emitted,
  // never from model text. `agent-activity-copy.test.ts` walks the token
  // lists in @flowstarter/agentic-codegen and fails if a row is missing here.
  'agentActivity.region': 'What the agent is doing',
  'agentActivity.expand': 'Show the steps',
  'agentActivity.collapse': 'Hide the steps',
  'agentActivity.step.repeat': '{label} ({count})',
  'agentActivity.failure': 'Stopped at {subject}',

  'agentActivity.step.thinking.active': 'Reading {subject}',
  'agentActivity.step.thinking.past': 'Read {subject}',
  'agentActivity.step.reading.active': 'Reading {subject}',
  'agentActivity.step.reading.past': 'Read {subject}',
  'agentActivity.step.editing.active': 'Editing {subject}',
  'agentActivity.step.editing.past': 'Edited {subject}',
  'agentActivity.step.searching.active': 'Searching {subject}',
  'agentActivity.step.searching.past': 'Searched {subject}',
  'agentActivity.step.checking.active': 'Checking {subject}',
  'agentActivity.step.checking.past': 'Checked {subject}',
  'agentActivity.step.repairing.active': 'Repairing {subject}',
  'agentActivity.step.repairing.past': 'Repaired {subject}',
  'agentActivity.step.building.active': 'Building {subject}',
  'agentActivity.step.building.past': 'Built {subject}',
  'agentActivity.step.publishing.active': 'Publishing {subject}',
  'agentActivity.step.publishing.past': 'Published {subject}',
  'agentActivity.step.done.active': 'Finishing {subject}',
  'agentActivity.step.done.past': 'Finished {subject}',
  'agentActivity.step.failed.active': 'Stopped at {subject}',
  'agentActivity.step.failed.past': 'Stopped at {subject}',

  'agentActivity.subject.page.home': 'the home page',
  'agentActivity.subject.page.about': 'the about page',
  'agentActivity.subject.page.services': 'the services page',
  'agentActivity.subject.page.work': 'the work page',
  'agentActivity.subject.page.contact': 'the contact page',
  'agentActivity.subject.page.pricing': 'the pricing page',
  'agentActivity.subject.page.gallery': 'the gallery page',
  'agentActivity.subject.page.booking': 'the booking page',
  'agentActivity.subject.page.blog': 'the blog page',
  'agentActivity.subject.page.legal': 'the legal pages',
  'agentActivity.subject.page.other': 'a page of the site',
  'agentActivity.subject.section.hero': 'the hero section',
  'agentActivity.subject.section.services': 'the services section',
  'agentActivity.subject.section.about': 'the about section',
  'agentActivity.subject.section.work': 'the work section',
  'agentActivity.subject.section.testimonials': 'the testimonials section',
  'agentActivity.subject.section.pricing': 'the pricing section',
  'agentActivity.subject.section.contact': 'the contact section',
  'agentActivity.subject.section.gallery': 'the gallery section',
  'agentActivity.subject.section.faq': 'the questions section',
  'agentActivity.subject.section.booking': 'the booking section',
  'agentActivity.subject.section.stats': 'the numbers section',
  'agentActivity.subject.section.header': 'the site header',
  'agentActivity.subject.section.footer': 'the site footer',
  'agentActivity.subject.section.cta': 'the call to action',
  'agentActivity.subject.section.other': 'a section of the site',
  'agentActivity.subject.content.site': 'the site copy',
  'agentActivity.subject.style.site': 'the site styling',
  'agentActivity.subject.setup.site': 'the site setup',
  'agentActivity.subject.image.site': 'the site images',
  'agentActivity.subject.file.other': 'the site files',
  'agentActivity.subject.brief': 'the brief',
  'agentActivity.subject.template.library': 'the template library',
  'agentActivity.subject.site': 'the site',
  'agentActivity.subject.preview': 'the preview',
  'agentActivity.subject.gate.links': 'the links check',
  'agentActivity.subject.gate.copy': 'the placeholder copy check',
  'agentActivity.subject.gate.images': 'the placeholder image check',
  'agentActivity.subject.gate.markup': 'the safe markup check',
  'agentActivity.subject.gate.brief': 'the brief check',
  'agentActivity.subject.gate.build': 'the build check',
  'agentActivity.subject.gate.pages': 'the page budget check',
  'agentActivity.subject.gate.changes': 'the approved changes check',
  'agentActivity.subject.gate.other': 'a quality check',

  'agentActivity.summary.page': 'Built 1 page',
  'agentActivity.summary.pages': 'Built {count} pages',
  'agentActivity.summary.check': 'checked 1 rule',
  'agentActivity.summary.checks': 'checked {count} rules',
  'agentActivity.summary.repair': '1 repair',
  'agentActivity.summary.repairs': '{count} repairs',
  'agentActivity.summary.empty': 'Finished',

  // Headlines, one per surface the timeline appears on.
  'agentActivity.headline.preview': 'Building your preview',
  'agentActivity.headline.previewDone': 'Your preview is ready',
  'agentActivity.headline.build': 'Building your site',
  'agentActivity.headline.buildDone': 'Your site is built',
  'agentActivity.headline.change': 'Applying your change',
  'agentActivity.headline.changeDone': 'Your change is live',
  'agentActivity.headline.changeReady': 'Your change is ready to save',
  'agentActivity.headline.stopped': 'Stopped',
  // The operator build board. The timeline is a tab of the build panel and a
  // folded line on each build card, so the tabs are named here together and
  // the two states the panel cannot draw itself have a line of their own.
  'agentActivity.operator.tab.conversation': 'Conversation',
  'agentActivity.operator.tab.activity': 'Activity',
  'agentActivity.operator.tab.log': 'Full log',
  'agentActivity.operator.waiting':
    'No steps yet. They appear here as the agents work.',
  'agentActivity.operator.none': 'This build recorded no steps.',
  'agentActivity.operator.error': 'Could not load what the agents did.',

  'agentActivity.editor.reading': 'Reading the page you are on',
  'agentActivity.editor.writing': 'Writing the change',
  'agentActivity.editor.checking': 'Checking the change is safe',
  'agentActivity.editor.saving': 'Saving the new version',
